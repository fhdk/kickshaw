...
static void write_tag (guint8 saving_stage, guint8 level, gchar **tag_elements, FILE *menu_file, GtkTreeModel *local_model, GtkTreeIter *local_iter, guint8 type);
static void get_field_values (gchar **txt_fields_array, GtkTreeModel *current_model, GtkTreeIter *current_iter);
static gboolean treestore_save_process_iteration (GtkTreeModel *filter_model, GtkTreePath *filter_path, GtkTreeIter *filter_iter, SaveMenuArgsData *save_menu_args);
